...
const ListingClient = ({
    ...
    // disabled the selected date range by user
    ...
    // Call if Submit
    const onCreateReseravtion = useCallback(() => {
        // Check login status
        if(!currentUser){
    ...
    }, [totalPrice, listing?.id, loginModal, currentUser, dateRange, router])

    // Update the listing price based on the selected date range
    useEffect(() => {
